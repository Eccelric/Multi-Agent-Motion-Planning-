...
def collision_checker(robot_1l, robot_2l, robot_3l, goal_states):
    robot_1, id_1 = robot_1l
    robot_2, id_2 = robot_2l
    robot_3, id_3 = robot_3l
    print("collision checker")
    
    #free_changed_coords_2 = robot_2.wait_for_changes([[robot_3.prev_state, robot_1.prev_state], 1])
    #free_changed_coords_3 = robot_3.wait_for_changes([[robot_1.prev_state, robot_2.prev_state], 1])
    """
    for coord in free_changed_coords_2:
        xj = coord
    ...
    for coord in free_changed_coords_3:
        xj = coord
    ...
    changed_coords_2 = []
    changed_coords_3 = []
    if robot_2.goal_state != robot_2.prev_state:
        if robot_2.current_state == robot_1.current_state:     
            ...
            changed_coords_2 = robot_2.wait_for_changes([[[robot_1.current_state], 16], [[robot_3.prev_state, robot_1.prev_state], 1]])
    ...
    if robot_3.goal_state != robot_3.prev_state:
        wait_for_changes_coords = [[[robot_1.prev_state, robot_2.prev_state], 1]]
        if robot_3.current_state == robot_1.current_state:      
            ...
            wait_for_changes_coords.extend([[[robot_1.current_state], 16]])
        ...
        if robot_3.current_state == robot_2.current_state:  
            ...
            wait_for_changes_coords.append([[robot_2.current_state], 16])
        changed_coords_3 = robot_3.wait_for_changes(wait_for_changes_coords)
